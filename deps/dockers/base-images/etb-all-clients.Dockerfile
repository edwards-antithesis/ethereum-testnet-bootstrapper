# built CL images
FROM lighthouse:v3.4.0 as lh_3_4_0_builder
FROM lighthouse:v3.3.0 as lh_3_3_0_builder
...
COPY --from=lh_3_4_0_builder /usr/local/bin/lighthouse /usr/local/bin/lighthouse_3_4_0/lighthouse
COPY --from=lh_3_3_0_builder /usr/local/bin/lighthouse /usr/local/bin/lighthouse_3_3_0/lighthouse
