...
class TestnetStatusChecker(object):
    ...
    def __update_health_metric(self):
        """
    ...
    def __test_for_one_head_block(self, unique_heads)-> tuple[bool, str]:
    ...
    def wait_until(self, log_prefix: str, t: int, do_health_metric: bool = False):
        """
        ...
        while int(time.time()) < t:
            ...
            if time_left > self.secs_per_eth2_slot:
                if do_health_metric:
                    _, msg = self.__test_for_one_head_block(self.__update_health_metric())
    ...
    def check_until(self, t: int, exit_early: bool = False) -> tuple[bool, str]:
        ...
        Implementation tries to perform health checks at the same frequency as slots change.

        Returns a boolean indicating whether the last health check passed, plus a message about the status.
        ...
        while True:
            ...
            if time_left > 0:
                ...
                if time_left > self.secs_per_eth2_slot:
                    result = self.__test_for_one_head_block(self.__update_health_metric())
